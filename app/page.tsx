...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050914] text-white">
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#050914]/85 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 md:px-6">
          ...
          <div className="flex gap-2">
            <Link href="/login" className="click-motion rounded-xl border border-white/10 px-4 py-2.5 text-sm font-bold hover:bg-white/5">
              Login
            </Link>
            <Link href="#produk" className="click-motion rounded-xl bg-gradient-to-r from-cyan-300 to-sky-400 px-4 py-2.5 text-sm font-black text-slate-950">
              Lihat Produk
            </Link>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 text-center md:px-6 md:py-32">
          ...
          <h1 className="mx-auto mt-7 max-w-4xl text-5xl font-black leading-[1.02] tracking-tight md:text-7xl">
            Semua kebutuhan digital <span className="bg-gradient-to-r from-cyan-300 via-sky-300 to-violet-300 bg-clip-text text-transparent">dalam satu tempat.</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="#produk" className="click-motion inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-300 to-sky-400 px-6 py-3.5 font-black text-slate-950">
      ...
      <section id="produk" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-16 md:px-6">
          ...
          {services.map(({ icon: Icon, title, text, href }) => (
            ...
            >
              ...
              <span className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-cyan-300">
                Lihat produk <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" />
              </span>
            </Link>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-6">
        <div className="rounded-[2rem] border border-cyan-300/15 bg-gradient-to-br from-cyan-300/[.07] to-violet-400/[.06] p-8 text-center md:p-12">
          ...
          <Link href="#produk" className="click-motion mt-6 inline-flex rounded-2xl bg-cyan-300 px-6 py-3 font-black text-slate-950">Lihat Produk</Link>
        </div>
      </section>
    </main>
  )
